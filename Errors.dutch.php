...
$txt['moved_no_access'] = 'Dit topic is verplaatst naar een board waar je geen toegang voor hebt.';
...
$txt['register_to_use'] = 'Het spijt ons,je moet je eerst registreren voordat....';
...
$txt['no_pinned_order'] = 'Er zijn geen vastgezette topics in dit board om te herordenen.';
...
$txt['cannot_pin_topic'] = 'Je hebt geen permissie om dit topic vast te zetten.';
...
$txt['cannot_merge_moved'] = 'Je kunt  "verwijderd topic" notificatie niet samenvoegen.';
...
$txt['cannot_modify_mod_post'] = 'Het spijt ons,maar je mag een bericht wat al is bewerkt door een moderator niet nog eens bewerken.';
...
$txt['cannot_issue_warning_self'] = 'Het spijt ons,maar je geen waarschuwing aan jezelf geven!!';
$txt['cannot_issue_warning_these_groups'] = 'Het spijt ons,maar je mag deze gebruiker geen waarschuwing geven.';
$txt['cannot_issue_warning_too_many'] = 'Het spijt ons,maar je mag deze gebruiker geen waarschuwing geven,je hebt te veel waarschuwingen vandaag gegeven.';
$txt['cannot_issue_warning'] = 'Sorry, je hebt geen permissie om waarschuwingen te geven aan leden.';
$txt['warning_not_found'] = 'Sorry, de gevraagde overtreding kon niet worden gevonden.';
$txt['cannot_revoke_warning'] = 'Helaas is het niet toegestaan ​​om deze overtreding te verwijderen.';
$txt['cannot_revoke_warning_self'] = 'Helaas is het niet toegestaan ​​om overtredingen van jezelf te verwijderen.';
$txt['cannot_revoke_already_revoked'] = 'Helaas kunt u deze overtreding niet verwijderen,is al eerder verwijderd.';
$txt['cannot_revoke_already_expired'] = 'Helaas kunt u deze overtreding niet verwijderen,is al verlopen.';
...
$txt['stats_not_available'] = 'De forumstatistieken zijn niet beschikbaar.';
...
$txt['under_age_registration_prohibited'] = 'Sorry, maar gebruikers jonger dan %1$d mogen zich niet registreren op dit forum.';

$txt['who_off'] = 'Je kunt niet bij <b>Wie is er online</b> omdat deze is uitgeschakeld.';

$txt['unsupported_browser'] = 'De browser die u momenteel gebruikt om deze website te bezoeken,%s, is verouderd, traag en onzeker. Wij raden u aan om te upgraden naar een nieuwere versie, of overschakelen naar een betere, meer modern alternatief zoals Google Chrome, Opera of Mozilla Firefox.';
...
$txt['reportWaitTime_broken'] = 'Het laatste topic rapport dat vanaf jouw IP is gepost is minder dan %1$d seconden geleden geplaatst. Probeer het later nog eens.';
...
$txt['error_not_permitted_content'] = 'Je bericht voldoet niet aan de forumregels.';
...
$txt['only_on_wedge'] = 'Sorry, dit soort activa kunnen alleen worden gedownload van een officiële bron.';
...
$txt['profile_error_password_short'] = 'Uw wachtwoord moet ten minste%1$d tekens lang zijn.';
...
$txt['database_error'] = 'Database fout';
// Use numeric entities in the below string, as it's to be used in emails.
$txt['tried_to_repair'] = 'Wedge heeft een ​​fout in uw database gedetecteerd en geprobeerd om deze automatisch te herstellen . Als u nog steeds problemen blijft ondervinden neem dan contact op met uw host.';

// Database errors (Class-DB.php)
$txt['mysql_error_space'] = ' - controleer database-opslagruimte.';
$txt['try_again'] = 'Probeer het opnieuw. Als de foutmelding op uw scherm blijft terugkom,meldt de fout dan aan een beheerder.';
// Line number in a file.
$txt['line'] = 'Lijn';

// Skin parsing errors
$txt['template_parse_error'] = 'Template Parse Fout!';
$txt['template_parse_error_message'] = 'Het lijkt erop dat er iets is fout gelopen op het forum met het template systeem. Dit probleem zou slechts tijdelijk kunnen zijn, probeer het later opnieuw. Als u dit bericht blijft zien, neem dan contact op met de beheerder.<br><br>Of probeer<a href="javascript:location.reload();">de pagina opnieuw te verversen</a>';
$txt['template_parse_error_details'] = 'Er was een probleem met het laden van de <tt><strong>%1$s</strong></tt> template of taalbestand.Controleer de syntaxis en probeer het opnieuw - denk aan, enkele aanhalingstekens(<tt>\'</tt>) vaak worden deze afgeslotem met een schuine streep  (<tt>\\</tt>) Meer specifieke informatie over PHP fouten zien, probeer <a href="{board_url}%1$s"> rechtstreeks toegang tot het bestand</a>.<br><br> U kunt proberen om<a href="javascript:location.reload();">de pagina te verversen</a> of <a href="<URL> ?theme=1">het standaard thema gebruiken</a>.';

$txt['security_risk'] = 'GROOT BEVEILIGINGSRISICO:';
$txt['cache_writable_head'] = 'Prestatie waarschuwing';
$txt['cache_writable'] = 'De cache directory is niet schrijfbaar - dit zal negatieve invloed hebben op de prestaties van uw forum.';
$txt['not_removed'] = 'U heeft <strong>%1$s</strong> niet verwijderd!';
$txt['not_removed_extra'] = '%1$s is een backup van %2$s niet gegenereerd door Wedge.Het kan direct worden benaderd en gebruikt worden om ongeautoriseerde toegang tot uw forum te krijgen.Advies om dit onmiddellijk te verwijderen.';

$txt['ssi_not_direct'] = 'Gebruik geen toegang tot SSI.php door een directe URL; wilt u misschien het pad (%1$s) gebruiken of toevoegen? ssi_function = iets.';
$txt['ssi_session_broken'] = 'SSI.php was niet in staat om een sessie te laden! Dit kan problemen met uitloggen en andere functies veroorzaken - zorg ervoor dat SSI.php is inbegrepen door * iets * anders in al uw scripts!';
...
$txt['ignoretopics_disallowed'] = 'De optie om onderwerpen te negeren is niet ingeschakeld.';
...
$txt['movetopic_no_pm'] = 'Je moet een persoonlijk bericht invullen bij het verplaatsen van dit onderwerp, of anders de optie \'stuur de topicstarter een bericht\' uitschakelen.';
...
// Merge double posts
$txt['merge_error_dbpo'] = 'U bent niet gemachtigd om deze actie uit te voeren.';
$txt['merge_error_notf'] = 'Sorry, kon geen enkele bericht vinden om samen te voegen.';
$txt['merge_error_noid'] = 'Bericht of Topic ID niet kunnen vinden!';
$txt['merge_error_length'] = 'Het verkregen resultaat van het samengevoegde bericht zou groter zijn dan de maximaal toegestane grootte!';

$txt['cannot_media_viewprofile'] = 'U kunt de Galerie profielen niet bekijken';
$txt['default_layer_missing'] = 'Wedge zal de inhoud van deze pagina niet laten zien,omdat de lay-out beschadigd blijkt te zijn door een afbeelding,thema of plugin<br><br>dit is gemeld aan de beheerder>';
$txt['error_mismatched_tags'] = 'Een niet passende BBCode tag werd gevonden zoals hieronder weergegeven; gelieve deze handmatig te repareren.<div class="bread">%1$s</div>';
$txt['error_missing_tags'] = 'U bent vergeten om een BBCode-tag te sluiten; voeg de ontbrekende tag handmatig zoals hieronder getoond wordt.<div class="bread">%1$s</div>';
