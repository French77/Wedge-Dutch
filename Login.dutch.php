...
$txt['maintain_mode'] = 'Onderhoudstand';
$txt['admin_login'] = 'Inloggen Beheerder';
$txt['username_no_exist'] = 'Gebruikersnaam bestaat niet.';
$txt['no_user_with_email'] = 'Er zijn geen gebruikersnamen gekoppeld aan dit e-mail adres.';
$txt['name_in_use'] = 'Gebruikersnaam is al in gebruik door een ander lid.';
$txt['mins_logged_in'] = 'Minuten ingelogd blijven.';
$txt['always_logged_in'] = 'Altijd ingelogd blijven.';

// Registration agreement page.
$txt['registration_agreement'] = 'Registratie overeenkomst';
$txt['registration_reagreement_force'] = 'De voorwaarden van de overeenkomst zijn veranderd sinds de laatste keer,om blijvend gebruik te kunnen maken van deze site, dient u eerst akkoord te gaan met de nieuwe voorwaarden.';
$txt['registration_reagreement_postonly'] = 'De voorwaarden van de overeenkomst zijn veranderd sinds de laatste keer.U kunt doorgaan met deze site door te bladeren, maar om berichten te kunnen plaatsen moet u akkoord gaan met de nieuwe voorwaarden.';
$txt['agreement_agree'] = 'Ik accepteer de overeenkomst voorwaarden.';
$txt['agreement_agree_coppa_above'] = 'Ik accepteer de overeenkomst voorwaarden.En ik ben tenminste %1$d jaar oud.';
$txt['agreement_agree_coppa_below'] = 'k accepteer de overeenkomst voorwaarden.En ik ben jonger dan %1$d jaar.';
$txt['noagreement_coppa_above'] = 'Ik ben tenminste %1$d jaar oud.';
$txt['noagreement_coppa_below'] = 'Ik ben jonger dan %1$d jaar.';
$txt['agreement_reagreed'] = 'Bedankt voor het accepteren van de overeenkomst voorwaarden.';
$txt['agreement_return_to'] = 'Terug naar waar ik gebleven was';

// Registration form.
$txt['registration_form'] = 'Registratie formulier';
...
$txt['choose_timezone'] = 'In welke tijdszone bevind u zich?';
$txt['registration_successful'] = 'Registratie geslaagd';
$txt['now_a_member'] = 'Gefeliciteerd! U bent nu lid van dit forum';
...
$txt['warning'] = 'Info!!';
$txt['only_members_can_access'] = 'Autorisatie Webmaster is vereist ';
$txt['login_below'] = 'Na autorisatie inloggen op  %1$s.';
$txt['login_below_register'] = 'Log hieronder in of <a href="%1$s">om je te registreren</a> met %2$s.';

$txt['login_hash_error'] = 'Wachtwoordbeveiliging is recentelijk bijgewerkt. Vul je wachtwoord opnieuw in.';
...
$txt['activate_after_registration'] = 'Bedankt voor het registreren. Je ontvangt een e-mail met een link om je account te activeren.  Als je na verloop van tijd geen e-mail hebt ontvangen, check dan even je spamfolder.';
...
$txt['setting_registration_both'] = 'Activatie via e-mail, daarna goedkeuring door beheerder';
$txt['setting_notify_new_registration'] = 'Breng beheerders op de hoogte als een nieuw lid zich geregistreerd heeft';
$txt['setting_send_welcomeEmail'] = 'Stuur een welkomst-e-mail naar het nieuwe leden';
$txt['purge_unactivated_days'] = 'Schrap niet geactiveerde accounts na hoeveel dagen?';
$txt['purge_unactivated_days_subtext'] = 'Wanneer ingesteld op 0, wordt er niets geschrapt';
$txt['purge_unactivated_days_postinput'] = 'dagen';

$txt['setting_coppaAge'] = 'Leeftijd waar beneden de registratie restricties gelden';
...
$txt['setting_coppaType_approval'] = 'Vereis ouderlijke/voogd goedkeuring';
...
$txt['admin_register_email'] = 'E-mail adres';
...
$txt['admin_register_password_desc'] = 'Wachtwoord voor nieuw lid';
...
$txt['coppa_after_registration'] = 'Bedankt voor je regstratie op {forum_name_html_safe}. <br ><br >Als lid onder de leeftijd van {MINIMUM_AGE} jaar is er een wettelijke verplichting
